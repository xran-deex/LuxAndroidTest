(defproject java_interop "0.1.0-SNAPSHOT"
  :plugins [[com.github.luxlang/lein-luxc "0.5.0"]]
  :resource-paths ["src" "/home/randy/Android/Sdk/platforms/android-25/android.jar" 
  ...
  :lux {:program "valis/lux/app" :target "libs"
        ...
        ;           :version 25
        ;           :resources ["res" "temp/appcompat/res"]
